...
public class DangaoCollectionView extends DangaoCollectionEntity implements Serializable {
	...
	*/
	...
	private String dangaoCollectionValue;
	...
	public DangaoCollectionView() {

	}

	public DangaoCollectionView(DangaoCollectionEntity dangaoCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, dangaoCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getDangaoCollectionValue() {
		return dangaoCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setDangaoCollectionValue(String dangaoCollectionValue) {
		this.dangaoCollectionValue = dangaoCollectionValue;
	}
	...
	public String toString() {
		return "DangaoCollectionView{" +
			", dangaoCollectionValue=" + dangaoCollectionValue +
