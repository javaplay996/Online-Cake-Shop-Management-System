...
var centerMenu = [
    ...
    ,{
        name: '商品收藏',
        url: '../dangaoCollection/list.html'
    }
    ,{
        name: '商品评价',
        url: '../dangaoCommentback/list.html'
    }
    ,{
        name: '商品订单',
        url: '../dangaoOrder/list.html'
    }
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/wangshangdangaodian/admin/dist/index.html#/login";
