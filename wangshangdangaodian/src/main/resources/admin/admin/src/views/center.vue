<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='dianyuan'"  label='店员名称' prop="dianyuanName">
               <el-input v-model="ruleForm.dianyuanName"  placeholder='店员名称' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='dianyuan'"  label='联系方式' prop="dianyuanPhone">
               <el-input v-model="ruleForm.dianyuanPhone"  placeholder='联系方式' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='dianyuan'"  label='邮箱' prop="dianyuanEmail">
               <el-input v-model="ruleForm.dianyuanEmail"  placeholder='邮箱' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
             <el-form-item v-if="flag=='dianyuan'"  label='店员类型' prop="dianyuanTypes">
                 <el-select v-model="ruleForm.dianyuanTypes"  placeholder='请选择店员类型'>
                     <el-option
         ...
         <el-col :span="24">
             <el-form-item v-if="flag=='dianyuan'"  label="店员介绍" prop="dianyuanContent">
                 <editor
...
// 注册表 店员 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         if((!this.ruleForm.dianyuanName)&& 'dianyuan'==this.flag){
                             this.$message.error('店员名称不能为空');
                             return
                         }

                         if((!this.ruleForm.dianyuanPhone)&& 'dianyuan'==this.flag){
                             this.$message.error('联系方式不能为空');
                             return
                         }

                             if( 'dianyuan' ==this.flag && this.ruleForm.dianyuanEmail&&(!isEmail(this.ruleForm.dianyuanEmail))){
                                 this.$message.error(`邮箱应输入邮箱格式`);
                                 return
                             }
                         if((!this.ruleForm.dianyuanTypes)&& 'dianyuan'==this.flag){
                             this.$message.error('店员类型不能为空');
                             return
                         }

                         if((!this.ruleForm.dianyuanContent)&& 'dianyuan'==this.flag){
