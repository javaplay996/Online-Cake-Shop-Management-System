            ...
            <el-table :data="forumData" height="250">
                ...
                <el-table-column label="身份">
                    <template slot-scope="scope">
                        ...
                        <span v-if="scope.row.dianyuanId">
                            店员
                        </span>
...
|| (sessionTable == 'dianyuan' && scope.row.dianyuanId ==userId)
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/wangshangdangaodian/upload/forumMuBan.xls"
                        >批量导入论坛数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('forum','导入导出')"
                ...
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <span v-if="scope.row.dianyuanId">
                                <div v-if="scope.row.dianyuanPhoto">
                                    <img :src="$base.url+scope.row.dianyuanPhoto" width="100" height="100">
                                </div>
                                <div v-else>无图片</div>
                            </span>
                            <span v-if="scope.row.usersId">
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        data.data.list.forEach(el=>{
                            ...
                            forum.dianyuanId = el.dianyuanId;//---
                            forum.dianyuanName = el.dianyuanName;
                            forum.dianyuanPhone = el.dianyuanPhone;
                            forum.dianyuanEmail = el.dianyuanEmail;
                            forum.dianyuanTypes = el.dianyuanTypes;
                            forum.dianyuanContent = el.dianyuanContent;
                            forum.dianyuanDelete = el.dianyuanDelete;
                            forum.createTime = el.createTime;
