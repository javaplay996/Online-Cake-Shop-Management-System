    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='dangao' ">
                    <el-form-item class="input" v-if="type!='info'"  label="商品编号" prop="dangaoUuidNumber">
                        <el-input v-model="dangaoForm.dangaoUuidNumber"
                                  placeholder="商品编号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="商品编号" prop="dangaoUuidNumber">
                            <el-input v-model="ruleForm.dangaoUuidNumber"
                ...
                <el-col :span="12"  v-if="sessionTable !='dangao' ">
                    <el-form-item class="input" v-if="type!='info'"  label="商品库存" prop="dangaoKucunNumber">
                        <el-input v-model="dangaoForm.dangaoKucunNumber"
                                  placeholder="商品库存" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="商品库存" prop="dangaoKucunNumber">
                            <el-input v-model="ruleForm.dangaoKucunNumber"
                                      placeholder="商品库存" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='dangao' ">
                    <el-form-item class="input" v-if="type!='info'"  label="购买获得积分" prop="dangaoPrice">
                        <el-input v-model="dangaoForm.dangaoPrice"
                                  placeholder="购买获得积分" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="购买获得积分" prop="dangaoPrice">
                            <el-input v-model="ruleForm.dangaoPrice"
                                      placeholder="购买获得积分" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='dangao' ">
                    <el-form-item class="input" v-if="type!='info'"  label="商品原价" prop="dangaoOldMoney">
                        <el-input v-model="dangaoForm.dangaoOldMoney"
                                  placeholder="商品原价" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="商品原价" prop="dangaoOldMoney">
                            <el-input v-model="ruleForm.dangaoOldMoney"
                                      placeholder="商品原价" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='dangao' ">
                    <el-form-item class="input" v-if="type!='info'"  label="商品热度" prop="dangaoClicknum">
                        <el-input v-model="dangaoForm.dangaoClicknum"
                                  placeholder="商品热度" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="商品热度" prop="dangaoClicknum">
                            <el-input v-model="ruleForm.dangaoClicknum"
